...
namespace Ex04MaxSequenceInArray
{
    class Ex04MaxSequenceInArray
    {
        static void Main(string[] args)
        {
            int[] testArray = {1,5,7,3,3,5,6,10,16,2,3,5,5,5,5,5,5,5,7,8,2};
            int maxSequence = 1;
            ...
            else
            {
                ...
                {
                    Console.Write("{0} ", testArray[lastOfSequence - i]);
                }
            }
        }
    }
